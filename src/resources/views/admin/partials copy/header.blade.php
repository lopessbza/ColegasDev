<nav class="app-header navbar navbar-expand bg-body">
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav ms-auto">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img
                  src="{{ asset('src/public/dash/assets/img/user1-128x128.jpg') }}"
                  alt="User Avatar"
      ...
      $fotoUser = $usuarioLogado && $usuarioLogado->foto_usuario ? asset('dash/asset/img/user/' .$usuarioLogado->foto_usuario) : asset('dash/asset/img/user/user.png');
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          ...
          <li class="user-header text-bg-primary">
            ...
            <p>
              ...
              <br>
              <small> Funcionario desde de: {{ date('d/m/Y', strtotime($usuarioLogado->criado_em_usuario)) }}</small>
            </p>
          </li>
          <!--end::User Image-->
